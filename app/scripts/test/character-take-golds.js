...
test('character: take golds', () => {
    ...
    character.takeGolds(10);

    expect('character has 101 golds', character.hasGolds(101));
    expect('character has 110 golds', character.hasGolds(110));
    expect('character does not have 111 golds', !character.hasGolds(111));
    expect('character does not have 1000 golds', !character.hasGolds(1000));
});